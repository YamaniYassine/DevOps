...
const Apropos = () => {
    return (
        <section style={{ backgroundColor: "white", padding: '15px', borderRadius: '15px'}}>
			<h1 style={{ fontSize: '2rem' }}>Apropos de nous</h1>
			...
			<ul style={{ textAlign: "left" }}>
				...
				<li>Alice Dupont - Responsable marketing</li>
				<li>Julien Martin - Responsable des ventes</li>
				<li>Marie Dubois - Responsable de la production</li>
			</ul>
            <h2>Nos valeurs</h2>
			<ul style={{ textAlign: "left" }}>
