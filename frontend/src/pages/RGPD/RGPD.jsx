    ...
    return (
        <section style={{ backgroundColor: "white", padding: '15px', borderRadius: '15px'}}>
            ...
            <ul style={{ textAlign: "left" }}>
                ...
                <li><strong>Données de paiement :</strong> informations bancaires ou informations nécessaires pour les paiements via nos partenaires de paiement.</li>
            ...
            <ul style={{ textAlign: "left" }}>
                ...
                <li><strong>Communication :</strong> vous envoyer des informations commerciales, des newsletters ou des mises à jour importantes liées à nos services (vous pouvez vous désinscrire à tout moment).</li>
                <li><strong>Respect de la législation :</strong> respecter nos obligations légales en matière de comptabilité et de protection des consommateurs.</li>
            </ul>
            ...
            <ul style={{ textAlign: "left" }}>
                ...
                <li><strong>Droit à la portabilité :</strong> vous pouvez demander une copie de vos données personnelles dans un format structuré, couramment utilisé et lisible par machine.</li>
                <li><strong>Droit d'opposition :</strong> vous pouvez vous opposer à la collecte et au traitement de vos données à tout moment, notamment pour des fins de prospection commerciale.</li>
            ...
            <p>Pour exercer vos droits, vous pouvez nous contacter directement à l'adresse suivante : [adresse email/contact]. Nous traiterons votre demande dans les plus brefs délais et conformément à la législation en vigueur.</p>

            <h2>7. Qui est responsable du traitement de vos données ?</h2>
            <p>Le responsable du traitement des données personnelles est <strong>ThéTipTop</strong>, dont le siège social est situé à [adresse complète].</p>

            <h2>8. Mise à jour de la politique de confidentialité</h2>
            <p>Cette politique de confidentialité peut être mise à jour régulièrement pour refléter les changements dans nos pratiques. La dernière mise à jour a été effectuée le [date de mise à jour].</p>
            
            <h2>9. Contact</h2>
            <p>Si vous avez des questions concernant la collecte et le traitement de vos données personnelles, ou si vous souhaitez exercer vos droits, veuillez nous contacter à l'adresse suivante : [adresse email].</p>
        </section>
    );
};
